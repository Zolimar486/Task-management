        ...
        <Bottom>
          <Form  onSubmit={handleSubmit} >
            <Items>
              ...
              <Input type="text" onChange={(e)=> setUsername(e.target.value)} placeholder= {user.username} />
            </Items>
            <Items>
              <Label>Email</Label>
          ...
          <Circle>
            ...
            <FontAwesomeIcon icon={faCircleXmark} style={{ color: "#808080", cursor: "pointer" }} onClick={()=> window.location.replace('/')}  />
          </Circle>
